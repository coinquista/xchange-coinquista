...
public class CoinquistaActiveOrder {
     ...
     * @param dealsCount
     */
    public CoinquistaActiveOrder(String amount, String baseAsset, String completedAmount, String completedRatio, String createdAt, Integer dealsCount, Integer id, String market, Integer orderType, String price, String quoteAsset, String rate, Integer side) {
        super();
        this.amount = amount;
